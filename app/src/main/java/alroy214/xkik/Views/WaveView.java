...
public class WaveView {
    ...
    public WaveView(View v) {
        width = v.getWidth();
        height = v.getHeight();
        init();
    }

    public WaveView(int w, int h) {
        width = w;
        height = h;
        init();
    }
     ...
     */
    private void createShader(Bitmap mutableBitmap) {
    ...
    public Canvas draw(Canvas canvas) {
        ...
        if (mShowWave) {
            ...
            if (mWaveShader !=null && mViewPaint.getShader() == null) {
                mViewPaint.setShader(mWaveShader);
            }
